...
export const siteConfig: SiteConfig = {
	title: "好想喝点奶绿",
	subtitle: "小破站",
	siteURL: "https://bs2644536256.date", // 请替换为你的站点URL，以斜杠结尾
...
export const profileConfig: ProfileConfig = {
	avatar: "https://tu.2644536256.date/file/奶绿/1778925756834_52.gif", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "好想喝点奶绿",
	bio: "个人技术生活博客",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo.2644536256.date",
		lang: SITE_LANG,
	},
	giscus: {
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		// "https://meting.mikus.ink/api?server=tencent&type=playlist&id=8941221193",
		"https://meting.mikus.ink/api?server=netease&type=playlist&id=907088656",// Meting API 地址
	id: "907088656", // 歌单ID
