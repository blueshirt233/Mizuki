...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/fcc81656a1ba70a22d27105720a831f7.jpeg#pic_center)
...
**不同点**：  
虚拟机技术：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0e48342276af9e315ec2df41536350d2.png#pic_center)

容器技术：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/62b35a8450d14e2ebad4a93daf01cfb8.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4ada14712270b92f1119eef968a391dc.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ee67fa5da6368f9dffbf1442d7afa4f7.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a8d3a3293172364143ce159994180aa7.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1baa52db53dfaf53fce04329684783fc.png#pic_center)  
...
运行项目并下载源码c运行12345678
```

iptables -nL  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/62bec5d74e1a20d8803570dcd34b0c96.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/409ef41ae974a5434b472cd92d6b3149.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/cb843791bd51e3367ebc1131c764c3b7.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7f75b12d3d245a061240c913b2cce0aa.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c010962285fa43a53b7636a0680662b1.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/70649bb0a77991392b6e2f078bced49d.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1e91477d29cb82361bc6278557d27d34.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/821af8906caee158677934a863727c5d.png#pic_center)  
可以看到此地址，代表配置成功。
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c37d3fb44a3c8cf63ec50b98f44ddf1b.png#pic_center)  
好了，这样就拉取下来了。
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/11e1b4b9c584bf8b3a4b4fd698d91046.png#pic_center)  
...
运行项目并下载源码c运行123456789101112131415161718192021222324252627
```
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/cfc21e304334c38f0ebf1ad94efcb30f.png#pic_center)

### 2、下载镜像。

docker pull nginx  
未指定nginx则直接下载最新版本  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b6b5795a3b2ae1c1052fb6c57007aa72.png#pic_center)

### 3、查看镜像。

docker images  
这里有作者下载的其他镜像。第一个就是我们刚刚下载的镜像。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5a47fb8a154aef25b9ccc96e80840c2d.png#pic_center)

### 4、启动容器。

docker run -d --name nginx01 -p 80:80 nginx  
e56开头那个就是容器ID  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/9fd77b0598dc03568d9b276909247766.png#pic_center)

### 5、查看容器。

docker ps  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6acc099932ca2e6c5f93a49720e5c8b6.png#pic_center)

### 6、测试访问。

curl 127.0.0.1:80  
127.0.0.1是本地回环ip，就是本机啦，可以用localhost代替。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/81e8ef89b25f43f220fdf24962d03fd3.png#pic_center)

### 7、进入容器修改页面。

docker exec -it 容器ID /bin/bash  
whereis是一个搜索文件的小命令，不如find好用但是简洁。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1fb69de6279ac792923d5b534dd8e031.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f7dda97e9a702a06c061626513852597.png#pic_center)  
...
如下图：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/bc7d22e5a1d48abe602b2c2b7a7b3185.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/fed611709c072cef0931b19c2f23e062.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/aeb4f7a475ddc3de720bd03dc7b8b3d2.png#pic_center)  
这里给大家举个栗子：  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/04703502a4c18197a427f2741e223efa.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/326f160cabfd461d220a8d505f314ed6.png#pic_center)  
2、启动tomcat。  
docker run -itd -p 8080:8080 tomcat:latest /bin/bash  
然后进入此容器  
docker exiec -it \[容器ID\] /bin/bash  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f45ccf34b5963288f93a9d3b3a5b81dd.png#pic_center)  
3、默认tomcat镜像的webapp网页文件里是没有东西的，我们要从webapps.dist中把它拷贝出来。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a032aae837d983d1db584fc446e6af52.png#pic_center)  
4、打开8080端口，在浏览器访问tomcat docker。  
![tomcat](https://i-blog.csdnimg.cn/blog_migrate/9a4838f6775619e6c1ff6aace30b6ccd.png#pic_center)  
5、提交镜像。  
docker commit -a=“This my create tomcat” -m=“add webapps app” 81 tomcat02:1.0  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2c72c79a1da7ac11b4ad1967163246b4.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/9a9c70b3e264e48d16338a61e22ffc82.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/3a3c4c86b059ddcf976a4216900d2c22.png#pic_center)  
我们在这里测试一下，echo进去一个a.txt文件。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e7f8ea132b8a317d81522865c9fd45b6.png#pic_center)  
然后来到宿主机上，看一眼是不是test01目录下也出现了a.txt。(双向绑定)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/844590b201babd7a2b5a8254cf5190ab.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/65f7dcd4a3b72e4117a46ad126dff3df.png#pic_center)  
...
然后使用刚刚教给大家的新武器查看卷。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c8a94033aabb6784ba96c57203f495d5.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b8ef1241eb1dbadb8d254a3fb3ea05c9.png#pic_center)  
怎么样，是不是在我们的宿主机就发现了这样的一个文件呢？这就是所谓的匿名挂载！是不是很简单。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a542c172b6f3f8e1277e5812f77296a2.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/65c389eeaf10c27488c4d7ff20fc93ae.png#pic_center)  
docker inspect ID | less 找到挂载点。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6d5b643a82420de1876a290b0f0dbd4d.png#pic_center)  
我们再复制一下路径，找到nginx的配置文件。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0ad7e30f459ee6109ddd2e8a65724c75.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5eb5935bb65372fa12c032604eb7c8d2.png#pic_center)  
...
运行项目并下载源码12345678910111213141516171819202122232425262728293031
```

Tips：构建镜像99%都是从scratch开始的，但是这个镜像是个虚拟的概念，并不实际存在，表示一个空白的镜像。

这里带大家回顾一下**docker history**命令。接下来我们就要用dockfile制作属于自己的镜像了。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/84b7a0c879ff401ba8449ab95507bd6d.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c9a1a4397f2ce0e9da4cb73ce033f0df.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d5d9e2fc8463622a91ad3fd6f43e11fd.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7c5bb0511466d7e5dbb154b640cef3e4.png#pic_center)

#### 2、编写dockerfile。

首先，我们知道官方默认的镜像，比如centos镜像里面，没有vim、ipconfig等命令，我们就基于此，创建此镜像。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/05ebf8d0f73ffe625dc1239a0e7c2895.png#pic_center)
...
CMD echo "------------END-------------"
CMD /bin/bash
运行项目并下载源码12345678910
```

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4ac98be61aa23ee757ad8501d744c96a.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8c887fcf775788a9875c993dd06bed05.png#pic_center)  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/74be14e9560b570e1a2c4522fec84ce4.png#pic_center)

到这里，我们就制作好了我们自己的镜像，虽然它并没有什么用。  
这里我们再启动我们自己制作的镜像，进去看看我们写的dockerfile都生效了没有。  
注：不加标签**默认是latest**，所以docker run的时候要带上镜像标签。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c86e72f7072acc4afcda7b9f4c2df76c.png#pic_center)  
同时，我们可以用**docker history**命令来进一步验证dockerfile的构建过程。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/3005087a544dc7e03fc48e225c38fd91.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0d2433377bc37fd36c2463146c4dc03f.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/9c17303d8c4e99ed7ef4f3d2d54c4ea8.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7ea7ea230206c321602a45b1c2b0135b.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/696781adefec50fe0f678f9bddabaddf.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2b5de27206bad2ffc59918200027737a.png#pic_center)  
理解：我们每启动一个docker容器，docker就会给docker容器分配一个ip，安装docker之后，会产生一个叫docker0的网卡，这里使用的就是**veth-pair技术**。

使用ip addr命令，查看我们的网卡。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/3df1db03c70175d70e235e40c6cf3148.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/79c3e21a23028c707cdbe02ee42d0c16.png#pic_center)

### 4、docker网络详解。

我们来绘制一个简单的网络模型，这样veth-pair的作用就清晰明了了。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c53d421e5e40c64468baa818846c0f55.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/77c81f9e7890f4a3bc95548e050836cf.png#pic_center)
...
只需要两条命令，你就创建完了自己的网络！  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4398d512187fc8273f7276884eb12129.png#pic_center)  
这里在教大家一条命令：
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/51bbbfe3a55015b3e335354d5ca8f469.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f33695cc3c1d24cc7100394940507c12.png#pic_center)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ac5c0d28bb4147cf5b7afce03dbeb397.png#pic_center)
